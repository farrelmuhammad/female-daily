            ...
            <nav class="bg-white px-2 sm:px-4 py-2.5 sticky w-full z-20 top-0 left-0 border-b border-gray-200">
                <div class="container flex flex-wrap items-center justify-between mx-auto">
                    <a href="https://flowbite.com/" class="flex items-center">
                        <img src={"https://s3.ap-southeast-1.amazonaws.com/assets.femaledaily.com/web-assets/icon/ic-fd.svg"} alt="Eventon Logo" />
                    </a>
                    ...
                    <form class="flex items-center w-[539px]">
                        ...
                        <div class="relative w-full">
                            ...
                            <input type="text" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-[8px] focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="Search products, articles, topics, brands, etc" />
                        </div>
                    ...
                    <div class="flex md:order-2 gap-2">
                        <button type="button" class="text-white bg-[#DC294F] hover:bg-[#ce274b] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-sm px-5 py-2.5 text-center uppercase mr-3 md:mr-0">
                            Login/Signup
                        </button>
